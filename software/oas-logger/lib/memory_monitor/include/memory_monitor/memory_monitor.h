...
inline void logHeap(const char* tag) {
  ...
  Serial.printf("[%s] 8bit: total=%u, free=%u, min=%u, largest=%u\n", tag,
  ...
  Serial.printf("[%s] internal: total=%u, free=%u, min=%u, largest=%u\n", tag,
  ...
  Serial.printf("[%s] psram: total=%u, free=%u, min=%u, largest=%u\n", tag,
